...
#     max_occurrence = max(
#         Counter(ff).most_common()[0][1], Counter(ss).most_common()[0][1]
#     )
...
#     song_extremes = np.array(
#         [(x, y) for x, y in zip(ff, ss)], dtype=[("ff", "<i4"), ("ss", "<i4")]
#     )
#     song_cmr = np.array(
#         [(x, y) for x, y in zip(cm, r)], dtype=[("cm", "<i4"), ("r", "<i4")]
#     )
...
#     flat = mat[
#         ~np.eye(n, dtype=bool)
#     ]  # this removes the diagonal and flattens at the same time
