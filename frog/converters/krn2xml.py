...
Augment and convert the data from .krn to .mxl.
I don't even know why we have this one here.
It was probably written to deal specifically with Tavern but now that we have converted that
entire dataset to mxl we do not really need this script anymore.
"""
import json
import os
