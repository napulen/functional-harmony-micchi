...
EPOCHS = 100
N_TRAIN = 372_924  # number of records in the training dataset as coming from the utils.count_tfrecords function
N_VALIDATION = 184_080  # number of records in the validation dataset as coming from the utils.count_tfrecords function
N_TEST = 191_892  # number of records in the validation dataset as coming from the utils.count_tfrecords function
